function GenerateFigures2andS2Graphs

% Function to examine signalling directionality in planar polarity.

% Biochemical reactions: 1. Fmi + Fmi -> Fmi:Fmi 2. Fz + Fmi:Fmi ->
% Fz-Fmi:Fmi 3. Vang + Fmi:Fmi -> Vang-Fmi:Fmi 4. Fz-Fmi:Fmi + Vang ->
% Fz-Fmi:Fmi-Vang 5. Vang-Fmi:Fmi + Fz -> Fz-Fmi:Fmi-Vang 6. Vang-Fmi:Fmi +
% Vang -> Vang-Fmi:Fmi-Vang 7. Fz-Fmi:Fmi + Fz -> Fz-Fmi:Fmi-Fz

% All complexes containing four proteins are stored in left hand edge of
% each cell. Complex formation is simulated in a 1D row of cells with
...
% Select a clone condition: Uncomment appropriate line to generate
% loss-of-function clones
clone = 'none'; % Used to generate Fig. 2B
% clone = ' fz'; % Used to generate Fig. 2C clone = ' Vang'; % Used to
% generate Fig. 2D

%% Parameters
num_cells = 30; % number of num_cells

% Mass action rate constants for no direct signalling
k1 = 1; k2 = 1; k3 = 1; k4 = 1; k5 = 1; k6 = 1; k7 = 1;
v1 = 5; v2 = 0.1; v3 = 0.1; v4 = 0.1; v5 = 0.1; v6 = 0.1; v7 = 0.1;

% Feedback parameters for Hill functions
thresh = 0.5; % referred to as K in paper
expon = 2; % referred to as w in paper
% Note: Vmax values are unbalanced in Fig. S2C example
Vmaxf = 10; % Vmax,F for destabilising feedback
Vmaxv = 10; % Vmax,V for destabilising feedback
...
%% Subfunctions
    ...
    function cell_plotter_LR(num_cells, array_L, array_R, t, name)
        % Plots a 1D row of cells, bar heights demonstrate amount of material
        % in each cell edge
