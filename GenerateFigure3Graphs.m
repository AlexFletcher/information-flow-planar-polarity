function GenerateFigure3Graphs
...
clone = ' fz'; % Used to generate Figs. 3B,C,I
% clone = ' Vang'; % Used to generate Figs. 3D,E,J clone = ' fmi'; % Used
% to generate Figs. 3F,G,K clone = ' Vangfz'; % Used to generate Fig. 3L

% Select appropriate Vmax,F and Vmax,V values Both are equal to 10 in Figs.
% 3B,D,F
