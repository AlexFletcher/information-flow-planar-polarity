function GenerateFigure4Graphs
...
clone = ' fz'; % Used to generate Figs. 4B,C,K
% clone = ' Vang'; % Used to generate Figs. 4D,E,L
% clone = ' fmi'; % Used to generate Figs. 4F,G,M
% clone = ' Vangfz'; % Used to generate Figs. 4H,I,N

% Select appropriate Vmax,F and Vmax,V values
% both are equal to 10 in Figs. 4B,D,F,H
% they are unequal and >=5 in Figs.4K-N
...
% Mass action rate constants for direct bidirectional signalling
k1 = 1; k2 = 1; k3 = 1; k4 = 1; k5 = 1; k6 = 1; k7 = 1;
v1 = 5; v2 = 0.1; v3 = 0.1; v4 = 0.01; v5 = 0.01; v6 = 0.1; v7 = 0.1;
