function GenerateFigures5Graphs
...
clone = ' fz'; % Used to generate Fig. 5C and S6C
% clone = ' Vang'; % Used to generate Fig. 5D and S6D
% clone = ' fmi'; % Used to generate Fig. 5E and S6E
% clone = ' Vangfz'; % Used to generate Fig. 5F and S6F

% Select appropriate Vmax,F and Vmax,V values
% both are equal and >= 4 in Fig.5
% Note: these are set to unequal values (and >=4) in Fig.S6C-F
Vmaxf = 5; % Vmax,F for destabilising feedback
Vmaxv = 5; % Vmax,V for destabilising feedback

%% Parameters

num_cells = 30; % number of num_cells

% Mass action rate constants for no direct signalling without symmetric
% complexes
k1 = 1; k2 = 1; k3 = 1; k4 = 1; k5 = 1; k6 = 0; k7 = 0;
